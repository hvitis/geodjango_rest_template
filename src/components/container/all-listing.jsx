...
class Listing extends Component {
    ...
    componentDidMount () {
        ...
        axios.get(`http://localhost:8000/api/accounts/detailed-profiles`)
            .then(res => {
                this.setState({
                    printers: res.data
                })
                            ...
                            <div className="col-lg-12 listing-items">
                                <div className="row">
                                    ...
                                    <div className="col-lg-8 order-lg-1 order-0">
                                        <div className="row">
                                        {                                            
                                            Object.values(this.state.printers).length ? (
                                                <Fragment>
                                                    <ListingCardGrid6 list={this.state.printers} logdIn={logdIn()} />
                                                    {/* <Pagination 
